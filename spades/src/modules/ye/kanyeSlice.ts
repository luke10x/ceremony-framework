...
// The `extraReducers` field lets the slice handle actions defined elsewhere, including:
// - actions generated by createAsyncThunk
// - or in other slices. 
//
// Since this is an API call we have 3 possible outcomes:
// - pending;
// - fulfilled;
// - and rejected.
//
// We have made allocations for all 3 outcomes. 
// Doing this is good practice as we can tap into the status of the API call
// and give our users an idea of what's happening in the background.
